...
if (gameState==2) {
 ...
 if (gameState==5) {
  ...
  text("This is a shield for 50 coin.Press d to buy it",1050,350)
  ...
  text("hsoldier damage : 10",50,570);
 ...
 if (gameState==6) {
  text("Plan your defense fast the aliens are gonna be attacking soon",150,100);
  row1();
  row2();
  row3();
  row4();
